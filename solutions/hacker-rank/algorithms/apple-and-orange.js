...
function isOnHouse(x, s, t) {
  return s <= x && x <= t;
}

function countFruits(s, t, f, fruits) {
  let result = 0;
  for (let d of fruits) {
    if (isOnHouse(f + d, s, t)) {
      result++;
    }
  }
  return result;
...
function countApplesAndOranges(s, t, a, b, apples, oranges) {
  console.log(countFruits(s, t, a, apples));
  console.log(countFruits(s, t, b, oranges));
}
